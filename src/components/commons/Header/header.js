                    ...
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col-4 bar">
                                <div>
                                    ...
                                    <div className="offcanvas offcanvas-start" tabIndex={-1} id="menu-left" aria-labelledby="offcanvasRightLabel">
                                            ...
                                            <Modal  visible={isMoodalOpen} onCancel={() => setIsModalOpen(false)} onOk={() => setIsModalOpen(false)}>
                                                Phiên làm việc đã hết hạn, vui lòng đăng nhập lại
                                            </Modal>
                                        
                                        <div className="offcanvas-header">
                                            {token ? <h5 id="offcanvasRightLabel">Welcome</h5> : <p id="offcanvasRightLabel">Bạn chưa đăng nhập</p>}
                                            <button type="button" className="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close" />
                                        </div>
                                        <div className="offcanvas-body">
                                            {token ? <div className="user-control">
                            ...
                            <div className="col-4 group-icon  text-2xl">
                                ...
                                {token  ? <Link to="/" id="signuptext">Hi {fname} {user.fullname} </Link> : <SignInSignUp />}
                            </div>
                        </div>
                    </div>
                </div>
